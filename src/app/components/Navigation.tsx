          ...
          <div className="flex items-center gap-3">
            {userEmail ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#0E1A07] text-white font-bold text-sm transition-all hover:scale-105 shadow-xl group border border-white/5"
              >
                Start for free
