  ...
  const features = [
    {
      ...
      description: 'Realistic tests that feel just like the real Digital SAT.',
      color: 'text-indigo-400'
    },
    {
      icon: Brain,
      title: 'Smart Lessons',
      description: 'Our system learns how you think and helps you improve where it matters most.',
      color: 'text-amber-400'
    },
    {
      icon: Activity,
      title: 'Progress Tracking',
      description: 'See exactly how much you have improved and what to work on next.',
      color: 'text-emerald-400'
    },
    {
      icon: ShieldCheck,
      title: 'Expert Content',
      description: 'Every question is carefully chosen to match the real exam difficulty.',
      color: 'text-indigo-400'
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-6 text-center z-10">
          ...
          <h1 className="text-6xl lg:text-8xl font-black text-white max-w-5xl mx-auto mb-8 tracking-tight leading-[1.1] animate-in fade-in slide-in-from-bottom-12 duration-700">
            Your path to a <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-indigo-200">perfect score.</span>
          </h1>

          <p className="text-xl text-white/60 max-w-2xl mx-auto mb-16 leading-relaxed font-medium animate-in fade-in duration-1000">
            Master the Digital SAT with a study plan that adapts to you.
            Simple, effective, and built for your success.
          </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-20">
            <div className="max-w-2xl">
              <div className="flex items-center gap-3 text-indigo-400 font-bold mb-6">
                ...
                <span className="uppercase tracking-widest text-xs">How it Works</span>
              </div>
              <h2 className="text-5xl lg:text-6xl font-black text-white tracking-tight">
                Personalized <br />
                <span className="text-slate-500">Practice Paths.</span>
              </h2>
            </div>
          </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/50 mb-16 max-w-xl mx-auto leading-relaxed">
            Get instant access to practice tests and start improving your score right now.
          </p>
          <button
            onClick={() => onNavigate('practice')}
