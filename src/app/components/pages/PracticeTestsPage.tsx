...
export function PracticeTestsPage({ onNavigate }: PracticeTestsPageProps) {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20 animate-in fade-in slide-in-from-bottom-2 duration-700">
          <div className="glass-card p-12 hover:bg-white/5 transition-all">
            <div className="text-[10px] font-black text-indigo-200/40 uppercase tracking-[0.4em] mb-6">Archive Density</div>
            <div className="text-6xl font-black text-white tracking-tighter">{tests.length} Sections</div>
          </div>
          <div className="glass-card p-12 hover:bg-white/5 transition-all">
            <div className="text-[10px] font-black text-indigo-200/40 uppercase tracking-[0.4em] mb-6">Temporal Window</div>
            <div className="text-6xl font-black text-white tracking-tighter">180m Limit</div>
          </div>
          <div className="glass-card p-12 hover:bg-white/5 transition-all">
            <div className="text-[10px] font-black text-indigo-200/40 uppercase tracking-[0.4em] mb-6">Total Tokens</div>
            <div className="text-6xl font-black text-white tracking-tighter">154 Items</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {loading ? (
            ...
            <div className="col-span-full py-32 text-center glass-card border-dashed border-white/10">
              <Info className="w-16 h-16 text-white/20 mx-auto mb-8" />
              <p className="text-white/40 font-black uppercase tracking-widest text-xs">No active sessions located in this node.</p>
            </div>
          ) : tests.map((test) => (
            <div key={test.id} className="group glass-card p-12 hover:bg-white/5 transition-all duration-700 border-white/10 hover:border-indigo-500/30">
              ...
              <div className="grid grid-cols-3 gap-8 mb-12">
                <div className="space-y-3">
                  ...
                  <div className="text-xl font-black text-white">{test.duration}</div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-white/30 font-black uppercase text-[9px] tracking-[0.3em]">
              ...
              <div className="space-y-10">
                ...
                <ul className="space-y-6">
                  {[
                    ...
                    '180-minute uninterrupted allocation',
