  ...
  const features = [
    {
      ...
      description: 'System simulations calibrated to the official Digital SAT architecture.',
      details: [
        'Timed sections with official break logic',
        'Module-based difficulty branching',
        'High-fidelity scaled scoring (400-1600)',
        'Desktop-optimized testing interface',
      ],
      color: 'text-cyan-400',
      bg: 'bg-indigo-500/10'
    },
    {
      ...
      description: 'Advanced error categorization to identify technical behavioral patterns.',
      details: [
        'Domain-specific mistake clustering',
        'Time-per-token efficiency metrics',
        'Distractor analysis for MCQs',
        'Standardized sub-score analytics',
      ],
      color: 'text-rose-400',
      bg: 'bg-rose-500/10'
    },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-32">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border-white/10 shadow-xl mb-10 animate-in fade-in slide-in-from-bottom-4 bg-white/5">
            ...
            <span className="text-[10px] font-black text-indigo-300 uppercase tracking-[0.3em]">Core System Engineering</span>
          </div>
          <h1 className="text-7xl lg:text-9xl font-black text-white mb-8 tracking-tighter leading-none italic">
            Process <span className="opacity-20 not-italic">Visualized.</span>
          </h1>
          <p className="text-2xl text-white/50 max-w-2xl mx-auto leading-relaxed font-bold">
            The architectural framework designed to eliminate score
            variance through technical precision.
          </p>
        </div>
          ...
          <div className="glass-card p-20 lg:p-32 text-center border-white/10 relative overflow-hidden group/cta">
            ...
            <div className="relative z-10">
              <h2 className="text-6xl lg:text-9xl font-black text-white tracking-tighter leading-tight mb-10 italic">
                Initialize <br /><span className="opacity-20 not-italic">Redesign.</span>
              </h2>
              <p className="text-2xl text-white/50 mb-16 max-w-2xl mx-auto font-bold leading-relaxed">
                Join the elite tier of students who have optimized their
                success through our engineering-first methodology.
              </p>
              <button
